...
export function ExteriorDesign() {
  ...
  const filterButtons = [
    ...
    "Ногоон байгууламж",
    "Тоглоомын талбай",
    "Оршин суугчдын хэсэг"
  ];

  // Generate facade images from 1 to 21
  const generateFacadeImages = () => {
    const facadeImages = [];
    for (let i = 1; i <= 21; i++) {
      facadeImages.push({
        src: `https://pub-6af6c7ad6eb64cf98a65d7fd500730d9.r2.dev/exterior/facade/${i}.jpg`,
        title: `Фасадын дизайн ${i}`,
        category: "Фасад"
      });
    }
    return facadeImages;
  ...
  const galleryImages = [
    ...generateFacadeImages(),
    {
      src: "https://pub-6af6c7ad6eb64cf98a65d7fd500730d9.r2.dev/exterior/green-landscaping/1.jpg",
      title: "Ногоон ландшафт 1",
      category: "Ногоон байгууламж"
    },
    {
      src: "https://pub-6af6c7ad6eb64cf98a65d7fd500730d9.r2.dev/exterior/green-landscaping/2.jpg",
      title: "Ногоон ландшафт 2",
      category: "Ногоон байгууламж"
    },
    {
      src: "https://pub-6af6c7ad6eb64cf98a65d7fd500730d9.r2.dev/exterior/green-landscaping/3.jpg",
      title: "Ногоон ландшафт 3",
      category: "Ногоон байгууламж"
    },
    {
      src: "https://pub-6af6c7ad6eb64cf98a65d7fd500730d9.r2.dev/exterior/green-landscaping/4.jpg",
      title: "Ногоон ландшафт 4",
      category: "Ногоон байгууламж"
    },
    {
      src: "https://pub-6af6c7ad6eb64cf98a65d7fd500730d9.r2.dev/exterior/playground/1.jpg",
      title: "Тоглоомын талбай 1",
      category: "Тоглоомын талбай"
    },
    {
      src: "https://pub-6af6c7ad6eb64cf98a65d7fd500730d9.r2.dev/exterior/playground/2.jpg",
      title: "Тоглоомын талбай 2",
      category: "Тоглоомын талбай"
    },
    {
      src: "https://pub-6af6c7ad6eb64cf98a65d7fd500730d9.r2.dev/exterior/playground/3.jpg",
      title: "Тоглоомын талбай 3",
      category: "Тоглоомын талбай"
    },
    {
      src: "https://pub-6af6c7ad6eb64cf98a65d7fd500730d9.r2.dev/exterior/residents-area/1.jpg",
      title: "Оршин суугчдын хэсэг 1",
      category: "Оршин суугчдын хэсэг"
    },
    {
      src: "https://pub-6af6c7ad6eb64cf98a65d7fd500730d9.r2.dev/exterior/residents-area/2.jpg",
      title: "Оршин суугчдын хэсэг 2",
      category: "Оршин суугчдын хэсэг"
    },
    {
      src: "https://pub-6af6c7ad6eb64cf98a65d7fd500730d9.r2.dev/exterior/residents-area/3.jpg",
      title: "Оршин суугчдын хэсэг 3",
      category: "Оршин суугчдын хэсэг"
    }
  ];
  ...
  const getFilteredImages = () => {
    let filtered = activeFilter === "Бүгд" 
      ? galleryImages 
  ...
  const handleImageClick = (imageIndex: number) => {
    ...
    if (activeFilter === "Бүгд" && !showAllImages && imageIndex === 5) {
      setShowAllImages(true);
      return;
    }
    
    const actualIndex = activeFilter === "Бүгд" && showAllImages 
      ? imageIndex 
      : activeFilter === "Бүгд" 
        ? imageIndex
        : galleryImages.findIndex(img => img === filteredImages[imageIndex]);
  ...
  const getPreviousImageIndex = () => {
    return (currentImageIndex - 1 + galleryImages.length) % galleryImages.length;
  };
  ...
  const getTransform = (position: 'previous' | 'current' | 'next') => {
  ...
  return (
    <section id="экстерьер" className="py-16 bg-muted/30">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl font-light text-muted-foreground max-w-3xl mx-auto">
            Барилгын гадна талын дизайн болон ландшафтын шийдлүүд.
            Таны амьдралын орчинг бүрэн дүүрэн болгох гадаад орон зайн шийдлүүд
          </p>
        </div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-full text-sm transition-all duration-200 ${
                activeFilter === filter
                  ...
                  : "bg-background text-muted-foreground hover:bg-accent shadow-sm border border-border"
              }`}
            >
              {filter}
            </button>
        ...
        {filteredImages.length > 0 ? (
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4">
            {filteredImages.map((image, index) => {
              const isLastImageInLimitedView = activeFilter === "Бүгд" && !showAllImages && index === 5;
                      ...
                      <div className="absolute inset-0 bg-black/40 group-hover:bg-black/60 transition-all duration-300 flex items-center justify-center">
                        <div className="bg-white/95 backdrop-blur-sm rounded-full p-4 shadow-lg group-hover:scale-110 transition-transform duration-300">
                          <div className="flex items-center space-x-2 text-gray-800">
                            ...
                            <span className="text-xl font-medium">{remainingImages}</span>
                          </div>
                        </div>
                      </div>
                    )}
        ...
        <Dialog open={isGalleryOpen} onOpenChange={setIsGalleryOpen}>
          ...
          >
            <VisuallyHidden>
              <DialogTitle>Экстерьер галерей - {currentImage?.title}</DialogTitle>
            </VisuallyHidden>
            <VisuallyHidden>
              <DialogDescription>Экстерьер дизайныг full-screen режимд харах</DialogDescription>
            </VisuallyHidden>
